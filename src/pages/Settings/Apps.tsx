  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 14, display: 'flex', flexDirection: 'column', gap: 8 }}>
        <AdminOnlyEntry label="Platform Manager" description="工厂 Agent、渠道配置、演化调度器" permissionLabel="系统管理员" />
        <AdminOnlyEntry label="Admin UI" description="API 密钥管理、应用统计、渠道监控" permissionLabel="内部运维" />
      </div>
